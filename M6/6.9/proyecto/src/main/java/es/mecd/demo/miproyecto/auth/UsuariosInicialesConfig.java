...
public class UsuariosInicialesConfig {
    ...
    CommandLineRunner cargarUsuarios(UsuarioRepository usuarios, RolRepository roles, PasswordEncoder encoder) {
        return args -> {
            ...
            Rol gestor = roles.findByNombre("GESTOR").orElseGet(() -> roles.save(new Rol("GESTOR", "Gestor")));
            ...
            crearSiFalta(usuarios, encoder, "gestor", "gestor123", "gestor@educacion.gob.es", user, gestor);
        };
    }
