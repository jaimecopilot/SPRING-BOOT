package es.mecd.demo.miproyecto.common.controller; import static
...
@SpringBootTest @AutoConfigureMockMvc @ActiveProfiles("test") class PublicControllerSecurityTest {
    @Autowired MockMvc mockMvc; @Test void info_200_sinAuth()throws Exception{
